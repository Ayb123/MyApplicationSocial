...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(fullName: String, userName: String, email: String,progressDialog:ProgressDialog) {
        ...
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/myapplicationsocial-bd59a.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=31552268-aedb-45e1-bdc8-bd9cbcb79c73"
