...
class AddPostActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        // Démarrer l'activité de recadrage de l'image
        CropImage.activity()
            .setAspectRatio(2,1)
    ...
    private fun uploadImage() {
        when{
            ...
            TextUtils.isEmpty(description_post.text.toString())-> Toast.makeText(this,"Please write description post .",Toast.LENGTH_LONG).show()
            else->{
                ...
                // Continuer la tâche de mise en ligne même en cas d'échec
